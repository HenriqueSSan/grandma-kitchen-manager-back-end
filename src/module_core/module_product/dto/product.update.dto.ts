...
const schema = z.object({
  ...
  qty: z.number().min(1, 'O campo de quantidade deve ter no mínimo 1').optional(),
  qty_minium: z.number().min(1, 'O campo de mínimo de quantidade deve ter no mínimo 1').optional(),
});

export class ProductUpdateDto implements DtoContract<z.infer<typeof schema>> {
